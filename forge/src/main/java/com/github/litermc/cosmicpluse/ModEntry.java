...
import com.github.litermc.cosmicpluse.platform.ForgeConfigFile;
...
public class ModEntry {
	...
	public static void onServerTick(final TickEvent.ServerTickEvent event) {
		switch (event.phase) {
		case START -> CosmicPluseListeners.preServerTick(event.getServer());
		case END -> CosmicPluseListeners.postServerTick(event.getServer());
		}
	}

	@SubscribeEvent
	public static void onRegisterCommands(final RegisterCommandsEvent event) {
		CosmicPluseCommands.register(event.getDispatcher());
	}
